    ...
    <div className="w-full overflow-x-auto max-w-full">
      <div className="flex flex-col md:flex-row items-center justify-center gap-5 mt-5">
        <input
          ...
          className="border border-gray-300 dark:border-gray-600 px-3 py-2 rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 mb-2 md:mb-0"
        />
        <input
          type="text"
        ...
        />
        <button
          className="py-3 px-8 bg-blue-600 dark:bg-blue-400 rounded-lg hover:bg-blue-800 dark:hover:bg-blue-300 transition-colors duration-150 text-white"
      ...
      <button
        className="py-3 px-8 bg-blue-600 dark:bg-blue-400 rounded-lg hover:bg-blue-800 dark:hover:bg-blue-300 transition-colors duration-150 text-white my-1 mr-32"
